...
export function TabBar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-md items-stretch justify-between gap-1 rounded-3xl border border-white/10 bg-surface/70 px-2 py-2 shadow-[0_8px_32px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
        {tabs.map((tab) => {
